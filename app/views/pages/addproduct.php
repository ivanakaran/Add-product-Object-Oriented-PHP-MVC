...
<form action="<?= URLROOT?>/pages/addproduct" id="product_form" class="py-4" method="POST">
  ...
  <div class="container">
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control <?=(!empty($data['sku_err'])) ? 'is-invalid' : ''?> " name="sku" id="sku"
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control <?=(!empty($data['name_err'])) ? 'is-invalid' : ''?>" name="name"
          id="name" placeholder="#name" value="<?=$data['name']?>">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="number" step="0.01" min="0"
          class="form-control <?=(!empty($data['price_err'])) ? 'is-invalid' : ''?>" name="price" id="price"
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <select name="type" class="form-control select <?=(!empty($data['type_err'])) ? 'is-invalid' : ''?>"
          id="productType" data-target=".type">
  ...
  <input type="hidden" class="form-control mb-4 <?=(!empty($data['typevalue_err'])) ? 'is-invalid' : ''?>" id="typev"
    name="typev">
